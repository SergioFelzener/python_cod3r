...
class Humano:
    ...
    def inteligente(self):
        raise NotImplementedError('Propriedade nao implementada, nao podendo afirmar na hierarquia')
...
if __name__ == '__main__':
    ...
    try:
        ...
        print('Error (Propriedade Abstrata)>> ' , error)
        
        jose = HomoSapiens("Jose")
        print('{} da classe {}, inteligente: {}'.format(jose.nome, jose.__class__.__name__, jose.inteligente))
        
        grunk = Neanderthal("Grunk")
        print('{} da classe {}, inteligente: {}'.format(grunk.nome, grunk.__class__.__name__, grunk.inteligente))
